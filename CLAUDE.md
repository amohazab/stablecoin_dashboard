...
- **Step 4 — IN PROGRESS (opened 2026-09-08, P-4.01):** GHO + LUSD adapters against the same memo and the same harness (brief §8.4; LUSD is the simplicity control).
