...
- **Step 5 — NEXT:** the verifiability module. It opens on the `supply_ruled` denominator (P-4.01 #3), since the tree publishes percentages and every adapter currently sets `supply_ruled = total_supply`.
