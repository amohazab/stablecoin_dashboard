...
**Governing artifacts (checksums):** `archetype-memo-1-cdp.md` 17553d7b · `intake-sheets-cdp.md` 29682310 · `phase-b-checklist.md` 54620383 — all at status "Phase B COMPLETE — 2026-09-02".
